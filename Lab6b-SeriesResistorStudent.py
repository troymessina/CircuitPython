...
for i in Vin_list: #loop to scan input voltage
    #Students edit four lines below
    Vin.value = int()#conversion to integer using i in place of Vin
    time.sleep(0.2)
    V2Volts = #conversion of V2 from integer to volts using V2.value
    V1_arr.append() # calculation of V1 using i as Vin and V2Volts
    I_arr.append() # conversion of V2 to current using R2 and V2Volts
    time.sleep(0.1)
